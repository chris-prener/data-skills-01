---
title: "Data Skills 01 - Introduction to RStudio and R Projects"
...
R is a programming language that is highly extensible and flexible - it can be adapted to work with everything from textual data to statistical and spatial data. [RStudio](http://rstudio.com) is a user interface for R that makes working with the language *much* easier. The first features below that we'll discuss briefly are all aspects of RStudio - they are not part of the basic R releases.
...
You can click on the geyser object in the `Enviornment` tab to open up the same spreadsheet view of the data.
